...
use Contest\Model\Map\QuestionI18nTableMap;
...
/**
 * Base class that represents a query for the 'question_i18n' table.
 *
 *
 *
 ...
 * @method     ChildQuestionI18nQuery orderByDescription($order = Criteria::ASC) Order by the description column
 *
 ...
 * @method     ChildQuestionI18nQuery groupByDescription() Group by the description column
 *
 ...
 * @method     ChildQuestionI18n findOneByDescription(string $description) Return the first ChildQuestionI18n filtered by the description column
 *
 * @method     array findById(int $id) Return ChildQuestionI18n objects filtered by the id column
 * @method     array findByLocale(string $locale) Return ChildQuestionI18n objects filtered by the locale column
 * @method     array findByTitle(string $title) Return ChildQuestionI18n objects filtered by the title column
 * @method     array findByDescription(string $description) Return ChildQuestionI18n objects filtered by the description column
 *
 */
abstract class QuestionI18nQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Contest\Model\Base\QuestionI18nQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'thelia', $modelName = '\\Contest\\Model\\QuestionI18n', $modelAlias = null)
    {
    ...
    {
        if ($criteria instanceof \Contest\Model\QuestionI18nQuery) {
            return $criteria;
        }
        $query = new \Contest\Model\QuestionI18nQuery();
        if (null !== $modelAlias) {
    ...
    public function findPk($key, $con = null)
    {
        ...
        if ((null !== ($obj = QuestionI18nTableMap::getInstanceFromPool(serialize(array((string) $key[0], (string) $key[1]))))) && !$this->formatter) {
    ...
    {
        $sql = 'SELECT ID, LOCALE, TITLE, DESCRIPTION FROM question_i18n WHERE ID = :p0 AND LOCALE = :p1';
        try {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            ...
            $obj->hydrate($row);
            QuestionI18nTableMap::addInstanceToPool($obj, serialize(array((string) $key[0], (string) $key[1])));
        }
        $stmt->closeCursor();
    ...
    {
        $this->addUsingAlias(QuestionI18nTableMap::ID, $key[0], Criteria::EQUAL);
        $this->addUsingAlias(QuestionI18nTableMap::LOCALE, $key[1], Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        foreach ($keys as $key) {
            $cton0 = $this->getNewCriterion(QuestionI18nTableMap::ID, $key[0], Criteria::EQUAL);
            $cton1 = $this->getNewCriterion(QuestionI18nTableMap::LOCALE, $key[1], Criteria::EQUAL);
            $cton0->addAnd($cton1);
            $this->addOr($cton0);
        }
    ...
    public function filterById($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(QuestionI18nTableMap::ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(QuestionI18nTableMap::ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(QuestionI18nTableMap::ID, $id, $comparison);
    }
    ...
    public function filterByLocale($locale = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(QuestionI18nTableMap::LOCALE, $locale, $comparison);
    }
    ...
    public function filterByTitle($title = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(QuestionI18nTableMap::TITLE, $title, $comparison);
    }
    ...
    public function filterByDescription($description = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(QuestionI18nTableMap::DESCRIPTION, $description, $comparison);
    }
    ...
    public function filterByQuestion($question, $comparison = null)
    {
        if ($question instanceof \Contest\Model\Question) {
            return $this
                ->addUsingAlias(QuestionI18nTableMap::ID, $question->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(QuestionI18nTableMap::ID, $question->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    {
        if ($questionI18n) {
            $this->addCond('pruneCond0', $this->getAliasedColName(QuestionI18nTableMap::ID), $questionI18n->getId(), Criteria::NOT_EQUAL);
            $this->addCond('pruneCond1', $this->getAliasedColName(QuestionI18nTableMap::LOCALE), $questionI18n->getLocale(), Criteria::NOT_EQUAL);
    ...
    /**
     * Deletes all rows from the question_i18n table.
     *
    ...
    /**
     * Performs a DELETE on the database, given a ChildQuestionI18n or Criteria object OR a primary key value.
     *
     * @param mixed               $values Criteria or ChildQuestionI18n object or primary key or array of primary keys
