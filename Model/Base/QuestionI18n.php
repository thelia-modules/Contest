...
abstract class QuestionI18n implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Contest\\Model\\Map\\QuestionI18nTableMap';
    ...
    /**
     * Initializes internal state of Contest\Model\Base\QuestionI18n object.
     * @see applyDefaults()
     */
     ...
     *
     * @return QuestionI18n The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[QuestionI18nTableMap::ID] = true;
        }
    ...
    public function setLocale($v)
    {
        ...
        if ($this->locale !== $v) {
            $this->locale = $v;
            $this->modifiedColumns[QuestionI18nTableMap::LOCALE] = true;
        }
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[QuestionI18nTableMap::TITLE] = true;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[QuestionI18nTableMap::DESCRIPTION] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : QuestionI18nTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = QuestionI18nTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating \Contest\Model\QuestionI18n object", 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(QuestionI18nTableMap::ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(QuestionI18nTableMap::LOCALE)) {
            $modifiedColumns[':p' . $index++]  = 'LOCALE';
        }
        if ($this->isColumnModified(QuestionI18nTableMap::TITLE)) {
            $modifiedColumns[':p' . $index++]  = 'TITLE';
        }
        if ($this->isColumnModified(QuestionI18nTableMap::DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'DESCRIPTION';
        }

        $sql = sprintf(
            'INSERT INTO question_i18n (%s) VALUES (%s)',
    ...
    {
        if (isset($alreadyDumpedObjects['QuestionI18n'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['QuestionI18n'][serialize($this->getPrimaryKey())] = true;
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(QuestionI18nTableMap::ID)) $criteria->add(QuestionI18nTableMap::ID, $this->id);
        if ($this->isColumnModified(QuestionI18nTableMap::LOCALE)) $criteria->add(QuestionI18nTableMap::LOCALE, $this->locale);
        if ($this->isColumnModified(QuestionI18nTableMap::TITLE)) $criteria->add(QuestionI18nTableMap::TITLE, $this->title);
        if ($this->isColumnModified(QuestionI18nTableMap::DESCRIPTION)) $criteria->add(QuestionI18nTableMap::DESCRIPTION, $this->description);
    ...
    {
        $criteria = new Criteria(QuestionI18nTableMap::DATABASE_NAME);
        $criteria->add(QuestionI18nTableMap::ID, $this->id);
        $criteria->add(QuestionI18nTableMap::LOCALE, $this->locale);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Contest\Model\QuestionI18n (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Contest\Model\QuestionI18n Clone of current object.
     * @throws PropelException
     */
